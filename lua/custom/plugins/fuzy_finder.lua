    ...
    require('telescope').setup {
      ...
      pickers = {
        buffers = {
          mappings = {
            i = {
              ["<C-d>"] = require('telescope.actions').delete_buffer,  -- Zavření bufferu v režimu "insert" ve výpisu bufferů
            },
            n = {
              ["d"] = require('telescope.actions').delete_buffer,  -- Zavření bufferu v režimu "normal" ve výpisu bufferů
            },
          },
        },
      },
